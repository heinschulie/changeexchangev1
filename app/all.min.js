...
!function(){"use strict";var t=angular.module("cxcApp"),e=function(t,e,a){e.data.bannerIndex=0,t.contentState=e,t.contentState.data.menuActive=!1,t.contentState.data.galleryViewing=!1,t.contentState.data.mobileBannerVideoPlay=!1,t.socialState=a;var n=function(){return e.getGalleries()};n()};t.controller("galleriesController",["$scope","contentState","socialState",e])}();
...
!function(){var e=angular.module("cxcApp");e.directive("cxcVideoCarousel",[function(){return{restrict:"E",templateUrl:"app/directives/templates/cxc-video-carousel.html",scope:{cxcvideocarouselcontent:"=",singular:"="},replace:!0,link:function(e){},controller:["$window","$scope","$sce","$sanitize","contentState",function(e,t,o,n,c){if(t.contentState=c,t.testClick=function(){t.test=!t.test},t.sharevideo=function(e){console.log(e),FB.ui({method:"share",display:"popup",href:"http://localhost:3000/Change-moments/Landing-that-Job/tutto-paella"},function(e){})},console.log("SINGULAR: "+t.singular),console.log("Outside video array setup."),t.cxcvideocarouselcontent.content&&!t.cxcvideocarouselcontent.videoArray){t.contentCopy=angular.copy(t.cxcvideocarouselcontent),t.contentCopy.content=t.contentCopy.content.replace("<p>","").replace("</p>","");var r=t.contentCopy.content.split("||");t.contentCopy.videoArray=[];var a=[];r.forEach(function(e){e=e.trim(),t.myModel={Url:e,Name:"Change Exchange Comp",ImageUrl:t.cxcvideocarouselcontent.featured_image.source};var n=o.trustAsResourceUrl(e),c={cleanUrl:n,shareUrl:e};t.singular?(a.push(c),t.contentCopy.videoArray.push(a),a=[]):a.length<2?a.push(c):(a.push(c),t.contentCopy.videoArray.push(a),a=[])})}}]}}])}();
