...
!function(){var t=angular.module("cxcApp");t.directive("cxcVideoBanner",[function(){return{restrict:"E",templateUrl:"app/directives/templates/cxc-video-banner.html",scope:{cxcvideobannercontent:"=",singular:"="},replace:!0,link:function(t){},controller:["$scope","$sce","$sanitize","contentState","socialState",function(t,e,n,c,o){t.contentState=c,t.testClick=function(){t.test=!t.test,console.log("Test = "+t.test)},console.log("SINGULAR: "+t.singular)}]}}])}();
