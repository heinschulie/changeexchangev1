...
!function(){"use strict";var t=angular.module("cxcApp"),e=function(t,e,n){t.contentState=n,t.contentState.data.galleryViewing=!1;var a=function(){return n.getPage(e.pagename)};a()};t.controller("pageController",["$scope","$routeParams","contentState",e])}();
!function(){"use strict";var t=angular.module("cxcApp"),e=function(t,e,a,o,s,r){t.sameAuthorPosts=[],t.sameCategoryPosts=[],t.recommendedMessageCat="",t.recommendedMessageAuthor="",t.contentState=r,t.contentState.data.galleryViewing=!1,t.socialState=s;var n=a.postId;t.callForPost=function(){return r.getPost(n).then(function(a){t.recommendedMessageCat="Enjoyed that article? Then we suggest you try one of these below...",t.recommendedMessageAuthor="More articles from "+r.data.post.author.name,t.facebooklikebutton=o.trustAsHtml('<div class="fb-like" ng-if="facebooklikeurl" data-ng-href="'+e.absUrl()+'" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>')})};var u=function(){r.getPostsByAuthor().then(function(e){t.sameAuthorPosts=e})},c=function(){t.sameAuthorPosts=r.data.posts.filter(function(t){return t.author.username===r.data.post.author.username&&t.ID!==r.data.post.ID}),t.sameAuthorPosts.length<3&&u(),t.sameCategoryPosts=r.data.posts.filter(function(t){if(t.ID===r.data.post.ID)return!1;for(var e=t.terms.category.map(function(t){return t.name}),a=0;a<e.length;a++)for(var o=0;o<r.data.categories.length;o++)if(e[a]===r.data.categories[o]&&"Change Moments"!==e[a]&&"Exchange"!==e[a])return!0})};t.callForPost().then(function(t){return r.data.posts.length<1?r.getPosts():void 0}).then(c)};t.controller("postController",["$scope","$location","$routeParams","$sce","socialState","contentState",e])}();
...
!function(){"use strict";var t=function(t,e,a,n,o,r,s){var c={categories:[],pageNumber:0,postsPerPage:18,post:{},posts:[],banners:[],galleries:[],artworks:[],galleryViewing:!1},g=["Landing that Job","Making a Home","Starting a Family","Tying the Knot","Ruda talks change","The Dan Nicoll Show","VeranderDinge"],u={name:"What change moment are you going through?",active:!0},i=[{name:"What change moment are you going through?",active:!1},{name:"Landing that Job",active:!1},{name:"Making a Home",active:!1},{name:"Starting a Family",active:!1},{name:"Tying the Knot",active:!1}],m=function(t){return n.getPage(t).then(function(t){c.page=t.data,c.page.content=e.trustAsHtml(c.page.content)})},h=function(t){return o.getPost(t).then(function(t){c.categories=t.data.terms.category.map(function(t){return t.name}),c.post=t.data,c.post.title=e.trustAsHtml(c.post.title),c.post.excerpt=e.trustAsHtml(c.post.excerpt),c.post.content=e.trustAsHtml(c.post.content)})},f=function(){return c.pageNumber=c.pageNumber+1,c.categories.length&&angular.forEach(c.categories,function(t){"events"===t.toLowerCase()&&r.changeSm(3,"fe")}),o.getPosts(c.postsPerPage,c.pageNumber,c.categories,!1).then(function(t){v(t.data,!1),1===c.pageNumber?c.posts=t.data:c.posts=c.posts.concat(t.data)})},p=function(){return o.getPostsByAuthor(c.post.author.ID).then(function(t){return v(t.data,!1),t.data})},l=function(){return o.getPosts(20,1,["art"],!0).then(function(t){c.artworks=t.data,angular.forEach(c.artworks,function(t){t.content=e.trustAsHtml(t.content),t.active=!1})})},d=function(){return o.getPosts(20,1,["gallery"],!1).then(function(t){v(t.data,!0),c.galleries=t.data})},b=function(t,e){var a=["banner"];return o.getBanners(c.postsPerPage,a).then(function(a){var n=[];t?(c.banners=[],angular.forEach(a.data,function(e){angular.forEach(e.terms.category,function(a){angular.forEach(t,function(t){a.name.toLowerCase()===t.toLowerCase()&&(n=n.concat(e))})})})):n=n.concat(a.data),e?(c.banners=[],angular.forEach(n,function(t){angular.forEach(t.terms.post_tag,function(e){"featured"===e.name.toLowerCase()&&(c.banners=c.banners.concat(t))})})):c.banners=c.banners.concat(n)})},v=function(t,e){var a=[];angular.forEach(t,function(t,n){angular.forEach(t.terms.category,function(o){"banner"===o.name.toLowerCase()&&(a.push(n),e&&(c.banners=[],c.banners.push(t)))}),angular.forEach(t.terms.post_tag,function(e){"featured"===e.name.toLowerCase()&&(t.featured=!0)})}),angular.forEach(a,function(e){t.splice(e,1)})},P=function(t,e){c.categories=[],t&&("What change moment are you going through?"===t.name?(i[0].active=!0,u=i[0],c.categories=c.categories.concat(g)):(u.name=t.name,c.categories.push(t.name))),angular.forEach(i,function(t){t.name===u.name?t.active=!0:t.active=!1}),c.pageNumber=0;var n=c.postsPerPage*c.pageNumber;return c.posts=c.posts.splice(0,n),"/home"===a.path()?f():(a.path("/home"),void(e&&b(c.categories)))};return{data:c,standardPostCategories:g,chosenMoment:u,changeMoments:i,selectedMoment:P,getPage:m,getPost:h,getPosts:f,getPostsByAuthor:p,getArtworks:l,getGalleries:d,getBanners:b}},e=angular.module("cxcApp");e.factory("contentState",["$timeout","$sce","$location","pageService","postService","socialState","errorState",t])}();
...
!function(){"use strict";var t=function(t,e,r){var n=e.serviceBase,c=function(e){return t.get(n+"posts/"+e).then(function(t){return t})["catch"](function(t){r.catchError(t)})},o=function(e,c,o,s){var i=n+"posts?filter[post_status]=publish&filter[posts_per_page]="+e+"&page="+c+"&fields=ID,title,excerpt";if(s&&(i+=",content"),o&&o.length>0){i+="&filter[category_name]=";for(var a=0;a<o.length;a++)i=i+","+o[a]}return i=i.replace("'",""),t.get(i).then(function(t){return t})["catch"](function(t){r.catchError(t)})},s=function(e){var r=n+"posts?filter[post_status]=publish&filter[posts_per_page]=3&filter[author]="+e+"&fields=ID,title,excerpt";return t.get(r).then(function(t){return t})},i=function(e,c){var o=n+"posts?filter[post_status]=publish&filter[posts_per_page]="+e+"&fields=ID,title,excerpt";if(c&&c.length>0){o+="&filter[category_name]=";for(var s=0;s<c.length;s++)o=o+","+c[s]}return o=o.replace("'",""),t.get(o).then(function(t){return t})["catch"](function(t){r.catchError(t)})};return{getPost:c,getPosts:o,getPostsByAuthor:s,getBanners:i}},e=angular.module("cxcApp");e.factory("postService",["$http","cxcService","errorState",t])}();
!function(){"use strict";var e=function(e){var a={currentSm:"fb",fbevents:!1,socialNetworks:[{id:1,abbrev:"fb",url:"https://www.facebook.com/brightrock","class":"fa fa-facebook-square",active:!1},{id:2,abbrev:"tw",url:"https://www.twitter.com/","class":"fa fa-twitter-square",active:!1},{id:3,abbrev:"fe",url:"https://www.facebook.com/brightrock/events","class":"fa fa-facebook-square",active:!1},{id:4,abbrev:"gg",url:"https://www.google.com/","class":"fa fa-google-plus-square",active:!1},{id:5,abbrev:"yt",url:"https://www.youtube.com/","class":"fa fa-youtube-square",active:!1}],videoPlayer:!1,firstheader:!1,secondheader:!1,thirdheader:!1},r=function(r,t){angular.forEach(a.socialNetworks,function(a){a.id===r?e.innerWidth<1224?e.open(a.url):a.active=!0:a.active=!1}),"fe"===t?(a.currentSm="fb",a.fbevents=!0):(a.fbevents=!1,a.currentSm=t),"yt"===t&&(a.videoPlayer=!1),"fb"===t&&(a.firstheader=!0,a.secondheader=!1,a.thirdheader=!1),"fe"===t&&(a.firstheader=!1,a.secondheader=!0,a.thirdheader=!1),"yt"===t&&(a.firstheader=!1,a.secondheader=!1,a.thirdheader=!0)};return{data:a,changeSm:r}},a=angular.module("cxcApp");a.factory("socialState",["$window",e])}();