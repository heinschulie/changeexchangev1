...
!function(){"use strict";var t=angular.module("cxcApp"),e=function(t,e,n){e.data.bannerIndex=0,t.contentState=e,t.contentState.data.menuActive=!1,t.contentState.data.galleryViewing=!1,t.socialState=n;var a=function(){return e.getGalleries()};a()};t.controller("galleriesController",["$scope","contentState","socialState",e])}();
