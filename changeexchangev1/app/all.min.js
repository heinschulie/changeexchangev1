...
!function(){var e=angular.module("cxcApp");e.directive("cxcBanner",[function(){return{restrict:"E",templateUrl:"app/directives/templates/cxc-banner.html",scope:{cxcbannercontent:"="},replace:!0,link:function(e){},controller:["$scope","$sce","contentState",function(e,n,c){e.contentState=c,("string"==typeof e.cxcbannercontent.excerpt||e.cxcbannercontent.excerpt instanceof String)&&(e.videoExists=!0,e.cxcbannercontent.excerpt=e.cxcbannercontent.excerpt.replace("<p>","").replace("</p>",""),e.cxcbannercontent.excerpt=n.trustAsResourceUrl(e.cxcbannercontent.excerpt))}]}}])}();
...
"use strict";app.factory("ajaxInterceptorService",["$q","$window","$location","errorState","cxcService",function(e,s,t,a,r){var o=(r.serviceBase,{}),n=function(e){return e.headers=e.headers||{},console.log("A request just left our shores"),e},u=function(e){console.log("There was a "+e.status+" error"),0===e.status?(a.data.firstMessage="Something went slightly wrong - but we don't have much idea what happened...",a.data.ajaxErrors.push(e)):401===e.status?(a.data.firstMessage="This page could not be found!",a.data.ajaxErrors.push(e)):500===e.status&&(a.data.firstMessage="There seems to have been an issue on our side... :(",a.data.ajaxErrors.push(e)),s.location.href="http://localhost:16327/oops.html"};return o.request=n,o.responseError=u,o}]);
...
!function(){"use strict";var t=function(t,e,a,n,o,r,s){var c={categories:[],pageNumber:0,postsPerPage:18,post:{},posts:[],banners:[],galleries:[],artworks:[],galleryViewing:!1,mobileBannerVideoPlay:!1},g=["Landing that Job","Making a Home","Starting a Family","Tying the Knot","Ruda talks change","The Dan Nicoll Show","VeranderDinge"],u={name:"What change moment are you going through?",active:!0},i=[{name:"What change moment are you going through?",active:!1},{name:"Landing that Job",active:!1},{name:"Making a Home",active:!1},{name:"Starting a Family",active:!1},{name:"Tying the Knot",active:!1}],m=function(t){return n.getPage(t).then(function(t){c.page=t.data,c.page.content=e.trustAsHtml(c.page.content)})},p=function(t){return o.getPost(t).then(function(t){c.categories=t.data.terms.category.map(function(t){return t.name}),c.post=t.data,c.post.title=e.trustAsHtml(c.post.title),c.post.excerpt=e.trustAsHtml(c.post.excerpt),c.post.content=e.trustAsHtml(c.post.content)})},h=function(t){return o.getPostByName(t).then(function(t){t.data.length&&(c.categories=t.data[0].terms.category.map(function(t){return t.name}),c.post=t.data[0],c.post.title=e.trustAsHtml(c.post.title),c.post.excerpt=e.trustAsHtml(c.post.excerpt),c.post.content=e.trustAsHtml(c.post.content),a.path("/"+c.post.ID))})},f=function(){return c.pageNumber=c.pageNumber+1,c.categories.length&&angular.forEach(c.categories,function(t){r.data.videoPlayer=!1,"events"===t.toLowerCase()&&r.changeSm(3,"fe")}),o.getPosts(c.postsPerPage,c.pageNumber,c.categories,!1).then(function(t){v(t.data,!1),1===c.pageNumber?c.posts=t.data:c.posts=c.posts.concat(t.data)})},l=function(){return o.getPostsByAuthor(c.post.author.ID).then(function(t){return v(t.data,!1),t.data})},d=function(t){return o.getPostsByTags(t).then(function(t){v(t.data,!1),c.pageNumber=1,c.posts=t.data})},P=function(){return o.getPosts(20,1,["art"],!0).then(function(t){c.artworks=t.data,angular.forEach(c.artworks,function(t){t.content=e.trustAsHtml(t.content),t.active=!1})})},b=function(){return o.getPosts(20,1,["gallery"],!1).then(function(t){v(t.data,!0),c.galleries=t.data})},y=function(t,e){var a=["banner"];return o.getBanners(c.postsPerPage,a).then(function(a){var n=[];t?(c.banners=[],angular.forEach(a.data,function(e){angular.forEach(e.terms.category,function(a){angular.forEach(t,function(t){a.name.toLowerCase()===t.toLowerCase()&&(n=n.concat(e))})})})):n=n.concat(a.data),e?(c.banners=[],angular.forEach(n,function(t){angular.forEach(t.terms.post_tag,function(e){"featured"===e.name.toLowerCase()&&(c.banners=c.banners.concat(t))})})):c.banners=c.banners.concat(n)})},v=function(t,e){var a=[];angular.forEach(t,function(t,n){angular.forEach(t.terms.category,function(o){"banner"===o.name.toLowerCase()&&(a.push(n),e&&(c.banners=[],c.banners.push(t)))}),angular.forEach(t.terms.post_tag,function(e){"featured"===e.name.toLowerCase()&&(t.featured=!0)})}),angular.forEach(a,function(e){t.splice(e,1)})},w=function(t,e){c.categories=[],t&&("What change moment are you going through?"===t.name?(i[0].active=!0,u=i[0],c.categories=c.categories.concat(g)):(u.name=t.name,c.categories.push(t.name))),angular.forEach(i,function(t){t.name===u.name?t.active=!0:t.active=!1}),c.pageNumber=0;var n=c.postsPerPage*c.pageNumber;return c.posts=c.posts.splice(0,n),"/home"===a.path()?f():(a.path("/home"),void(e&&y(c.categories)))};return{data:c,standardPostCategories:g,chosenMoment:u,changeMoments:i,selectedMoment:w,getPage:m,getPost:p,getPostByName:h,getPosts:f,getPostsByAuthor:l,getPostsByTags:d,getArtworks:P,getGalleries:b,getBanners:y}},e=angular.module("cxcApp");e.factory("contentState",["$timeout","$sce","$location","pageService","postService","socialState","errorState",t])}();
