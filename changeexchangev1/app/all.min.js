...
!function(){"use strict";var t=angular.module("cxcApp"),e=function(t,e,n,a,o,r,c){t.contentState=o,t.socialState=r,t.errorState=a,t.active=!1,t.toggleMenu=function(){t.active?t.active=!1:t.active=!0},t.scroll=0,t.$watch(e.scrollY,function(e,n){e>0?t.minimalHeader=!0:t.minimalHeader=!1}),t.callForPosts=function(){return"/home"===n.path()?o.getPosts():void n.path("/home")};var i=function(e){return c.getCategories(e).then(function(e){t.exchangeCategories=e.data})};i("Exchange"),o.data.banners&&o.data.banners.length||o.getBanners(null,!0)};t.controller("indexController",["$scope","$window","$location","errorState","contentState","socialState","categoryService",e])}();
!function(){"use strict";var t=angular.module("cxcApp"),e=function(t,e,a,n){t.contentState=a,t.contentState.data.galleryViewing=!1,n.data.videoPlayer=!1;var o=function(){return a.getPage(e.pagename)};o()};t.controller("pageController",["$scope","$routeParams","contentState","socialState",e])}();
