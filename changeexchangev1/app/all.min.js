...
!function(){var e=angular.module("cxcApp");e.directive("cxcVideoCarousel",[function(){return{restrict:"E",templateUrl:"app/directives/templates/cxc-video-carousel.html",scope:{cxcvideocarouselcontent:"=",singular:"="},replace:!0,link:function(e){},controller:["$scope","$sce","$sanitize","contentState",function(e,t,o,c){if(e.contentState=c,e.testClick=function(){e.test=!e.test},console.log("SINGULAR: "+e.singular),console.log("Outside video array setup."),e.cxcvideocarouselcontent.content&&!e.cxcvideocarouselcontent.videoArray){e.contentCopy=angular.copy(e.cxcvideocarouselcontent),e.contentCopy.content=e.contentCopy.content.replace("<p>","").replace("</p>","");var n=e.contentCopy.content.split("||");e.contentCopy.videoArray=[];var r=[];n.forEach(function(o){o=o.trim(),e.myModel={Url:o,Name:"Change Exchange Comp",ImageUrl:e.cxcvideocarouselcontent.featured_image.source};var c=t.trustAsResourceUrl(o),n={cleanUrl:c,shareUrl:o};e.singular?(r.push(n),e.contentCopy.videoArray.push(r),r=[]):r.length<2?r.push(n):(r.push(n),e.contentCopy.videoArray.push(r),r=[])})}}]}}])}();
