...
!function(){"use strict";var t=angular.module("cxcApp"),o=function(t,o){t.contentState=o;callForPosts()};t.controller("aboutController",["$scope","contentState",o])}();
...
!function(){var c=angular.module("cxcApp");c.directive("cxcBanner",[function(){return{restrict:"E",templateUrl:"app/directives/templates/cxc-banner.html",scope:{cxcbannercontent:"="},replace:!0,link:function(c){},controller:["$scope",function(c){c.testClick=function(){alert(c.cxccontent.title)}}]}}])}();
